...
logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(name)s - %(levelname)s - %(message)s',filename='./logs.log',filemode='a')
...
class Classifier:
    ...
    def eda(self):
        ...
        try:
            ...
            plt.title("Hist-Plot", weight='bold', fontsize=20, color='Red')
            for i, col in enumerate(self.numerical_cols):
                plt.subplot(3, 3, i + 1)
    ...
    def training(self):
        ...
        try:
            ...
            logging.info("Training function executed successfully")
    ...
    def evaluation(self):
        ...
        try:
            ...
            logging.info("Evaluation function executed successfully")
        except Exception as e:
